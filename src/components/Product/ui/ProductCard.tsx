...
export const ProductCard = (props: ProductCardProps) => {
  const { category, description, name, price, images } = props

  return (
    <article className="group relative overflow-hidden rounded-xl bg-white p-4 shadow-lg transition-all hover:shadow-xl max-w-[30vw]">
